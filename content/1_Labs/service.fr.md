...
3. **Créer un pod de test et installer les outils DNS :**

Lancer un pod avec l'image `ubuntu` et ouvrir un shell interactif à l'intérieur.
...
4. **Effectuer une requête DNS pour le service alpaca-prod :**
...
5. **Tester la connectivité avec le service :**
...
# Supprimer le service et le deployment alpaca-prod
